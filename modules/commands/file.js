...
function _0x4a78() {
    var _0x984ffc = ['endsWith', 'split', 'statSync', '🍀Có ', 'threadID', '🐸Không có file nào trong cache có ký tự bắt đầu bằng: ', 'files', '[Folder🗂️]', '🐸Không có file nào trong tên có ký tự: ', 'author', 'isFile', 'readdirSync', 'sendMessage', '7501500AHEsuo', 'Xóa file hoặc folder trong thư mục commands', 'isDirectory', '[File📄]', '12061shVDYP', 'length', '11561hebuCR', ' file có ký tự bắt đầu là: ', '🍀Tất cả các file trong thư mục commands:', '3AGJuSP', 'includes', 'help', 'messageID', 'start', '🐳Đã xóa các file sau trong thư mục commands:\x0a\x0a', 'startsWith', '1579035UBQyhz', '100004269364835', '🐸Commands của bạn không có file hoặc folder nào', 'handleReply', '\x0acommands start <text>\x0acommands ext <text>\x0acommands <text>\x0acommands [để trống]\x0acommands help\x0aNOTE: <text> là ký tự bạn điền vào tùy ý', '440NcFWpb', 'filter', 'senderID', ' file trong tên có ký tự: ', '117498LRanDw', 'run', 'fs-extra', 'NTKhang mod Dyy', '498310JIuLHL', 'Định làm gì thế anh bạn :))', 'map', '1834180aAxSCn', 'rmdirSync', 'slice', 'join', '85TkhhmB', 'config', 'exports', '6830HvgrNR', 'Admin', 'ext'];
    _0x4a78 = function () {
        return _0x984ffc;
    };
    return _0x4a78();
