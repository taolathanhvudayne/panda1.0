...
module.exports.run = async function ({
    ...
    try {
        const res = await axios.get(`https://api.leanhtruong.net/v2/taixiu.php?api_key=LEANHTRUONG=GUX4WlnWySRkCv3WiLF0838xDeK0TijajZIZ8BTNC5fGsTORG6=APIKEY=PLANFREE&bet=t%C3%A0i`);
        var data = res.data;
